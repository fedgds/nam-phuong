...
<body>
    <header class="header scroll">
        <div class="head-container scroll">
            ...
            <div class="right">
                <a href="<?= home_url(); ?>/reservation" target="_blank" class="res">Reservation</a>
                <a href="<?= get_field('order_online', 'option'); ?>" target="_blank" class="order">Order online</a>
            </div>
        </div>
            ...
            <div class="breadcrumb-header">
                <div class="top">
                    <a href="/">
                        <div class="logo">
                            <figure>
                                <img src="<?= get_template_directory_uri(); ?>/dist/assets/image/logo-mobile.svg"
                                    alt="logo">
                            </figure>
                        </div>
                    </a>
